...
AWS_ACCESS_KEY_ID = 'AKIA2AAQ3QQVINV3PNUN'
AWS_SECRET_ACCESS_KEY = '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'
AWS_REGION = 'ap-south-1'
BUCKET_NAME = 'filesharingapp'
...
def decrypt_data():
    data = request.json
    s3_object_hashes = data.get('s3ObjectHashes')
